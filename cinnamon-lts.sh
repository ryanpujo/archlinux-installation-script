...
sudo pacman -Syu xorg xorg-xinit cinnamon metacity gnome-shell lightdm lightdm-gtk-greeter lightdm-slick-greeter gtk-engine-murrine gtk-engines p7zip unrar xz nemo-fileroller xreader xed nemo kitty libreoffice gst-libav gst-plugin-pipewire gst-plugins-bad gst-plugins-ugly gstreamer-vaapi archlinux-wallpaper firefox vlc papirus-icon-theme mtpfs gvfs-mtp dbeaver docker docker-compose jdk17-openjdk ttf-fira-code go rhythmbox terminus-font powerline-fonts ttf-font-awesome adobe-source-code-pro-fonts ttf-jetbrains-mono noto-fonts noto-fonts-emoji noto-fonts-extra awesome-terminal-fonts
